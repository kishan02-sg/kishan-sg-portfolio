...
export default function PublicationsFooterSection() {
  ...
  useEffect(() => {
    ...
    if (!isMobile && canvas && videoEl) {
      ...
      videoEl.src       = '/assets/footer-video-v2.mp4'
      videoEl.muted     = true
    ...
    <div ref={wrapperRef} className={styles.wrapper}>
      <div ref={stickyRef} className={styles.sticky}>
        ...
        <div className={styles.mobileFooterBg}>
          <Image
            src="/assets/kishan-mobile-footer-v3.webp"
            alt=""
            fill
            quality={100}
        ...
        <div ref={imageWrapRef} className={styles.imageWrap}>
          <Image
            src="/assets/kishan-footer-v3.jpeg"
            alt=""
            fill
            quality={100}
        ...
        <div ref={pubContentRef} className={styles.pubContent}>
          ...
          <div className={styles.pubHero}>
            <p  ref={labelRef}   className={styles.label}>Recognition</p>
          ...
          <div ref={bottomBarRef} className={styles.bottomBar}>
            <div className={styles.bottomLeft}>
              <div className={styles.monogram}>
                <span className={styles.monoLetters}>{profile.name.first[0]}{profile.name.last[0]}</span>
